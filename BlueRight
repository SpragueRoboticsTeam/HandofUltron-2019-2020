...
public class BlueRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,   30.5, 30.5, 0, 0);  // S2: Turn Right 12 Inches with 4 Sec timeout
        ...
        encoderDrive(DRIVE_SPEED, 0,0 ,33, 33); //+ distance --> left
        ...
        //encoderDrive(DRIVE_SPEED, -1.5,1.5 ,1.5, -1.5); //+ distance --> left
        encoderDrive(DRIVE_SPEED, 0,0 ,-41, -41); //- distance --> right

        encoderDrive(DRIVE_SPEED, 16,16 ,0, 0);
